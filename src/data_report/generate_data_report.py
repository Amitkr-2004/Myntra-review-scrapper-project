...
class DashboardGenerator:
    ...
    def display_general_info(self):
        ...
        #Convert all columns to numric value for proper visualization
        ...
        fig_pie = px.pie(product_ratings,values='Over_All_Rating',names='Product Name',title='Average Ratings of Product')
